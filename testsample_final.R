...
Example <- data.frame(order_id = c(seq(1, 140, 1), seq(1, 140, 7), seq(1, 140, 7), seq(3, 140, 7), seq(3, 140, 7), seq(3, 140, 7), seq(4, 140, 7), seq(4, 140, 7), seq(4, 140, 7), seq(4, 140, 7)),
                      menu_name = c(sample(c("소고기샤브-9900", "소고기토마토샤브-10900", "소고기커리샤브-10900", "한우샤브_맑은육수-15900", "한우샤브_매운육수-15900", "한우샤브_커리육수-15900"), 140, replace=TRUE),
                                    ...
                                    sample(c("소고기샤브-9900", "소고기토마토샤브-10900", "소고기커리샤브-10900", "한우샤브_맑은육수-15900", "한우샤브_매운육수-15900", "한우샤브_커리육수-15900"), 20, replace=TRUE), sample(c("소고기샤브-9900", "소고기토마토샤브-10900", "소고기커리샤브-10900", "한우샤브_맑은육수-15900", "한우샤브_매운육수-15900", "한우샤브_커리육수-15900"), 20, replace=TRUE), sample(c("소고기샤브-9900", "소고기토마토샤브-10900", "소고기커리샤브-10900", "한우샤브_맑은육수-15900", "한우샤브_매운육수-15900", "한우샤브_커리육수-15900"), 20, replace=TRUE), sample(c("소고기샤브-9900", "소고기토마토샤브-10900", "소고기커리샤브-10900", "한우샤브_맑은육수-15900", "한우샤브_매운육수-15900", "한우샤브_커리육수-15900"), 20, replace=TRUE)),
                      option_name = c(sample(c("없음_0", "고기추가_4000", "모듬_3000", "모듬버섯_1500", "어묵꼬치_1500", "모듬떡_ 1000", "만두쌀떡_1000", "모듬채소_1500", "국수추가_1000", "영양죽_1000", "생수_500", "콜라_1000"), 320, replace=TRUE)),
                      count = c("1"))
...
reserve  <- reserve %>% arrange(order_id)
#여기부터
...
Sample$total_price <- left_join(Sample, Example_tot_price, by = ("order_id" = "order_id"))$final_price
head(Sample)
...
#옵션
Option <- data.frame(option_name = c("고기추가", "모듬", "모듬버섯", "어묵꼬치", "모듬떡", "만두쌀떡", "모듬채소", "국수추가", "영양죽", "생수", "콜라"),
...
#재료
Ingredient <- data.frame(ing_name = c("고기재료", "배추", "단호박", "숙주", "느타리버섯", "팽이버섯", "청경채", "치즈떡", "쌀떡", "만두", "국수면", "쌀", "어묵", "계란", "물", "탄산", "다시다", "커리", "토마토"),
                         stock = c("190", "130", "130", "130", "150", "150", "150", "150", "200", "200", "250", "470", "350", "500", "1000", "1000", "740", "680", "150"),
                         expiration_date = c("5", "4", "4", "4", "2", "2", "3", "6", "6", "10", "60", "150", "3", "20", "500", "450", "365", "365", "5"),
                         ing_price = c("8000", "500", "500", "80", "500", "500", "100", "150", "150", "400", "200", "350", "220", "130", "40", "30", "50", "450", "370"),
                         recevie_date=as.Date(c("2019-05-25", "2019-05-26", "2019-05-26", "2019-05-26", "2019-05-25", "2019-05-25", "2019-05-26", "2019-04-17", "2019-04-17", "2019-05-22", "2019-05-20", "2019-05-11", "2019-05-26", "2019-05-21", "2019-04-15", "2019-04-15", "2019-05-07", "2019-05-07", "2019-05-24")),
                         supplier = c("농협", "농산물도매", "농산물도매", "농산물도매", "이마트", "이마트", "농산물도매", "코스트코", "코스트코", "이마트", "코스트코", "이마트", "이마트", "이마트", "코스트코", "코스트코", "코스트코", "코스트코", "농산물도매"),
                         ing_cost = c("5000", "300", "300", "30", "300", "350", "40", "60", "60", "220", "90", "120", "90", "70", "20", "25", "15", "230", "160"))
...
Menu_Option$count <- as.numeric(Menu_Option$count)
...
Menu_Ingredient <- data.frame(menu_name = c("소고기샤브", "소고기샤브", "소고기샤브", "소고기샤브", "소고기샤브", "소고기샤브", "소고기샤브", "소고기샤브", "소고기샤브", "소고기샤브", "소고기샤브",
                              ...
                              ing_name = c("고기재료", "배추", "단호박", "숙주", "느타리버섯", "팽이버섯", "청경채", "치즈떡", "쌀떡", "만두", "다시다",
                                           "고기재료", "배추", "단호박", "숙주", "느타리버섯", "팽이버섯", "청경채", "치즈떡", "쌀떡", "만두", "커리",
                                           "고기재료", "배추", "단호박", "숙주", "느타리버섯", "팽이버섯", "청경채", "치즈떡", "쌀떡", "만두", "토마토",
                                           "고기재료", "배추", "단호박", "숙주", "느타리버섯", "팽이버섯", "청경채", "치즈떡", "쌀떡", "만두", "다시다",
                                           "고기재료", "배추", "단호박", "숙주", "느타리버섯", "팽이버섯", "청경채", "치즈떡", "쌀떡", "만두", "커리",
                                           "고기재료", "배추", "단호박", "숙주", "느타리버섯", "팽이버섯", "청경채", "치즈떡", "쌀떡", "만두", "토마토"))
...
#옵션_재료
Option_Ingredient <- data.frame(option_name = c("고기추가", 
...
name2 <- sample(c("선", "정", "혜", "지", "예", "소", "수", "전", "다", "유"), 70, replace = TRUE)
name3 <- sample(c("애", "승", "원", "림", "수", "영", "환", "우", "연", "현"), 70, replace = TRUE)
name <- paste0(name1, name2, name3, collapse = NULL)

Customer <- data.frame(custom_id = c(1:70),
                       custom_name = name,
                       custom_sex = sample(c("여", "여", "여", "남"), 70, replace = TRUE),
                       custom_age = sample(c(18:35), 70, replace = TRUE),
                       ewhain = sample(c(TRUE, FALSE), 70, replace = TRUE))

write.csv(Customer, "C:/Project/data/Customer.csv", row.names = FALSE)

Customer <- read.csv("C:/Project/data/Customer.csv", header = TRUE)
head(Customer)
#추가 코드
...
#추가코드
Reservation$reserve_time <- as.character(Reservation1$reserve_time)
head(Reservation)
h <- substr(Reservation$reserve_time, 1, 2)
m <- substr(Reservation$reserve_time, 3, 4)
s <- sample(c(10:59), 30)
Reservation$reserve_time <- paste0(h, sep = ':', m, sep = ':', s)
